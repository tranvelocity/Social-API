...
use Modules\Post\app\Http\Controllers\PostNewsFeedController;
...
Route::group(['prefix' => Config::get('api.version'), 'middleware' => ['post_social']], function () {
    Route::resource(Config::get('api.endpoints.posts_social'), PostNewsFeedController::class, ['only' => ['index']]);
});
